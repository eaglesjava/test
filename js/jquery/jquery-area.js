  $(function(){
            var addressSelector = function(province,city,district){
	            ...
	            if(province.length <2){
	                    ...
	                    for(var i in data){
	                    if(data[i][1] == "1"){
							html += "<option value=\""+i+"\">"+data[i][0]+"</option>";
	                    }
	                }
	                province.html(html);
	            }
        ...
        addressSelector.prototype.data = {
            ...
            var residenceAddress = new addressSelector($("#province"),$("#city"),$("#district"));
            ...
            // var residenceAddress = new addressSelector($('#province'),$('#city'),$('#district'));
            // var nowAddress = new addressSelector($('#Nowprovince'),$('#Nowcity'),$('#Nowdistrict'));
